require('dotenv').config({ path: '../.env' }); // For local development, look for .env in the parent directory
// In production, you would typically have a local .env or set environment variables in cPanel directly.
...
// We use VITE_ prefix as fallback since locally we read from the parent Vite .env file
  ...
  try {
    ...
    const bodyHtml = `
      ...
      <body>
        <div class="container">
          <div class="header">
            <!-- CID points to the attachment id below -->
